...
export default function ArchiveView({
  ...
  const routeProjectDraft = useMemo(() => {
    ...
    // Seed project coords from the university (school location) rather
    // than the world's narrative location, so each project gets its own
    // independently-placeable marker.
