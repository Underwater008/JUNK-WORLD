...
export default function CoverImageUpload({
  ...
  if (!imageUrl) {
    return (
      <label className="group flex h-32 cursor-pointer items-center justify-center bg-[#F0EDE6] transition-colors hover:bg-[#E8E4DB]">
  ...
  return (
    <div className="group relative aspect-[16/9] mx-auto max-w-2xl overflow-hidden">
      <img
        src={imageUrl}
        alt="Cover"
